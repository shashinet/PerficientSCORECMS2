define("domanager-resources/editors/display/displayOptionsContentAreaOverlay", [
  // Dojo
  "dojo/_base/array",
  "dojo/_base/declare",
  "dojo/_base/lang",
  ...
  // Resources
  "dojo/text!epi-cms/widget/templates/ContentArea.html"
], function (
  // Dojo
  array,
  declare,
  ...
  return declare([Item, _Container, _TextWithActionLinksMixin], {
    ...
    _createBlock: function (node) {
      ...
      // pass the displayoptions defined on the contentarea to the command by hitching it to model
      indexChild.containerDO = this.displayOptions;
