                  ...
                  value: function (e, t) {
                    ...
                    if (null != i) {
                      ...
                      if ('string' == typeof i) {
                        this._log('\nKey: '.concat('' === n ? '-' : n));
                        var S = f.search(i);
                        if (this._log('Full text: "'.concat(i, '", score: ')
                          .concat(S.score)), this.options.tokenize) {
                          for (var x = i.split(this.options.tokenSeparator), b = [], M = 0; M < l.length; M += 1) {
                            ...
                            for (var L = !1, w = 0; w < x.length; w += 1) {
                              var A = x[w],
                                C = _.search(A),
                                I = {};
                              C.isMatch ? (I[A] = C.score, y = !0, L = !0, b.push(C.score)) : (I[A] = 1, this.options.matchAllTokens || b.push(1)), this._log('Token: "'.concat(A, '", score: ')
                                .concat(I[A]));
                            }
                            L && (k += 1);
                          }
                        ...
                        var P = S.score;
                        m > -1 && (P = (P + m) / 2), this._log('Core average:', P);
...
// EXTERNAL MODULE: ./node_modules/symbol-observable/es/entry.js
...
// CONCATENATED MODULE: ./node_modules/redux/es/redux.js
        ...
        function getUnexpectedStateShapeWarningMessage(inputState, reducers, action, unexpectedKeyCache) {
          ...
          if (!isPlainObject(inputState)) {
            return 'The ' + argumentName + ' has unexpected type of "' + {}.toString.call(inputState)
              .match(/\s([a-z|A-Z]+)/)[1] + '". Expected argument to be an object with the following ' + ('keys: "' + reducerKeys.join('", "') + '"');
          }

          var unexpectedKeys = Object.keys(inputState)
            .filter(function (key) {
...
// CONCATENATED MODULE: ./src/scripts/reducers/entry.js
...
// CONCATENATED MODULE: ./src/scripts/components/entry.js
        ...
        var choices_Choices =
          ...
          function () {
            ...
            _proto._handleButtonAction = function _handleButtonAction(activeItems, element) {
              ...
              }); // Remove item associated with buttonLink
            ...
            _proto._onEnterKey = function _onEnterKey(_ref4) {
              ...
              var targetWasButton = target.hasAttribute('data-buttonLink');
