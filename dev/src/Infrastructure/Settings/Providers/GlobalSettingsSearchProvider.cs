...
namespace Perficient.Infrastructure.Settings.Providers
{
    [SearchProvider]
    public class GlobalSettingsSearchProvider : ContentSearchProviderBase<SettingsBase, ContentType>
    {
        ...
        protected override string GetEditUrl(SettingsBase contentData, out bool onCurrentHost)
        {
            ...
            var language = localizable.Language.Name;

            return
                $"/episerver/Perficient.Web.Core.Settings/settings#context=epi.cms.contentdata:///{contentLink.ID}&viewsetting=viewlanguage:///{language}";
        }
    }
}
