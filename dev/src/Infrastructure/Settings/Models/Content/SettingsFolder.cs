...
namespace Perficient.Infrastructure.Settings.Models.Content
{
    ...
    public class SettingsFolder : ContentFolder
    {
        ...
        public static readonly Guid SettingsRootGuid = new Guid("79611ee5-7ddd-4ac8-b00e-5e8e8d2a57ee");
        ...
        public override string Name
        {
            get
            {
                ...
                {
                    var localizedFolderName = _localizationService.Service.GetString("/contentrepositories/globalsettings/Name");

                    return string.IsNullOrEmpty(localizedFolderName) ? "Site Settings" : localizedFolderName;
                }
