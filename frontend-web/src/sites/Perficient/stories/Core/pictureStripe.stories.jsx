...
import PictureStripe from '../../../../core/react/PictureStripe';
import { PrimaryCardHorizontal } from '../../../../core/stories/cards/card.stories';
  ...
  children: (
    <>
      <div className="w-4col">
        <PrimaryCardHorizontal {...PrimaryCardHorizontal.args} />
      </div>
      <div className="w-4col">
        <PrimaryCardHorizontal {...PrimaryCardHorizontal.args} />
      </div>
